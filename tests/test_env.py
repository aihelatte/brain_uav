...
class TestStaticNoFlyEnv(unittest.TestCase):
    ...
    def test_config_uses_target_distance_derived_world_xy(self):
        ...
        self.assertEqual(cfg.warning_distance, 100.0)
        ...
        self.assertEqual(rewards.progress_weight, 2.0)
        self.assertEqual(rewards.zone_penalty_weight, 450.0)
        self.assertEqual(rewards.zone_penalty_cap, 1200.0)
        self.assertEqual(rewards.ground_soft_penalty_weight, 180.0)
        self.assertEqual(rewards.ground_soft_penalty_cap, 300.0)
        self.assertEqual(rewards.descent_trend_penalty_weight, 120.0)
        self.assertEqual(rewards.descent_trend_penalty_cap, 260.0)
        self.assertEqual(rewards.boundary_soft_penalty_weight, 180.0)
        self.assertEqual(rewards.boundary_soft_penalty_cap, 240.0)
        ...
        self.assertEqual(rewards.collision_penalty, 24000.0)
        self.assertEqual(rewards.boundary_penalty, 24000.0)
